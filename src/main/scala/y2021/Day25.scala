...
object Day25 extends App {
  ...
  val (r, d, e) =
    data
      .zipWithIndex
      .foldLeft((Set.empty[(Int, Int)], Set.empty[(Int, Int)], Set.empty[(Int, Int)])) { case ((rc, dc, ec), (row, rIndex)) =>

        row.zipWithIndex.foldLeft((rc, dc, ec)) { case ((rc2, dc2, ec2), (ch, cIndex)) =>
  ...
  def shiftNTimes(rightCoords: Set[(Int, Int)], downCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)], timesRemaining: Int): (Set[(Int, Int)], Set[(Int, Int)], Set[(Int, Int)]) = {
    println("------------------")
  ...
  def shiftUntilDone(rightCoords: Set[(Int, Int)], downCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)], timesShifted: Int): Int = {
    val (nr, nd, ne) = shiftArray(rightCoords, downCoords, emptyCoords)
  ...
  def shiftArray(rightCoords: Set[(Int, Int)], downCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)]): (Set[(Int, Int)], Set[(Int, Int)], Set[(Int, Int)]) = {
  ...
  def moveRight(rightCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)]): (Set[(Int, Int)], Set[(Int, Int)]) = {
  ...
  def moveDown(downCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)]): (Set[(Int, Int)], Set[(Int, Int)]) = {
  ...
  def move(rightCoords: Set[(Int, Int)], emptyCoords: Set[(Int, Int)])(f: (Int, Int) => (Int, Int)): (Set[(Int, Int)], Set[(Int, Int)]) = {
    rightCoords.foldLeft((Set.empty[(Int, Int)], Set.from(emptyCoords))) { case ((newRight, newEmpty), (r, c)) =>
      val nextMove = f(r, c)
  ...
  def printGrid(right: Set[(Int, Int)], down: Set[(Int, Int)], empty: Set[(Int, Int)]): Unit = {
