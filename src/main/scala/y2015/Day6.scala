    ...
    if (instructions.isEmpty) {
      ...
      instructions.head match {
        case On(r1, c1, r2, c2) =>
          turnOnLights(
            instructions.tail,
            onLights ++ createLights(r1.toInt, c1.toInt, r2.toInt, c2.toInt)
          )
        ...
        case Toggle(r1, c1, r2, c2) => {
          val toggleLights =
            createLights(r1.toInt, c1.toInt, r2.toInt, c2.toInt)
